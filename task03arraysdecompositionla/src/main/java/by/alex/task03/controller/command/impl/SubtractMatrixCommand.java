...
public class SubtractMatrixCommand implements Command {

    private static final Logger LOGGER = LoggerFactory.getLogger(SubtractMatrixCommand.class);
    private final MatrixService matrixService;
    private final MessageManager messageManager;

    public SubtractMatrixCommand() {
    ...
    @Override
    public void execute() {
        LOGGER.trace("Executing subtract matrices command");
