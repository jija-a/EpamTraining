...
public class InsertionSortCommand implements Command {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(InsertionSortCommand.class);
    private final CustomArrayService arrayService;
    private final MessageManager messageManager;

    public InsertionSortCommand() {
    ...
    @Override
    public void execute() {
        LOGGER.trace("Executing insertion sort command");
        ...
        if (array.isEmpty()) {
            ...
            arrayService.insertionSort(array.get());
