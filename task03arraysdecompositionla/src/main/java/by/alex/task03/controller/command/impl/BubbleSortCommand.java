...
public class BubbleSortCommand implements Command {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BubbleSortCommand.class);
    ...
    @Override
    public void execute() {
        LOGGER.trace("executing bubble sort command");
        ...
        if (array.isEmpty()) {
            ...
            arrayService.bubbleSort(array.get());
