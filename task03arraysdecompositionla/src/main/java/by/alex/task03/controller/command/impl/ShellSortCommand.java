...
public class ShellSortCommand implements Command {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ShellSortCommand.class);
    private final CustomArrayService arrayService;
    private final MessageManager messageManager;

    public ShellSortCommand() {
    ...
    @Override
    public void execute() {
        LOGGER.trace("Executing Shell sort command");
        ...
        if (array.isEmpty()) {
            ...
            arrayService.shellSort(array.get());
