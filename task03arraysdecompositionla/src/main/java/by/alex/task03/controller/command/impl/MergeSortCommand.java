...
public class MergeSortCommand implements Command {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MergeSortCommand.class);
    private final CustomArrayService arrayService;
    private final MessageManager messageManager;

    public MergeSortCommand() {
    ...
    @Override
    public void execute() {
        LOGGER.trace("executing merge command");
        ...
        if (array.isEmpty()) {
            ...
            arrayService.mergeSort(array.get());
